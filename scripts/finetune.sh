...
if [ "$GRAPH_TOWER" == "hvqvae2" ]; then
    ...
    ADAPTER="${CHECKPOINT_FOLDER_PREFIX}/llava-${GRAPH_TOWER}-${MODEL_VERSION}-pretrain/mm_projector.bin"
...
deepspeed llava/train/train_mem.py \
    ...
    --lora_enable True \
    --model_name_or_path ./checkpoints/Graph-LLaVA-4C-hvqvae2-5ep-hlinear-fgprompt-neg-extend/MoleculeNet-llava-hvqvae2-vicuna-v1-3-7b-finetune_lora\
...
deepspeed llava/train/train_mem.py \
    ...
    --version $PROMPT_VERSION \
    --data_path ./data/data/Molecule-oriented_Instructions/property_prediction-train.json \
    --data_type $TASK \
    --graph_tower $GRAPH_TOWER \
    --graph_pooling "mean" \
    --init_checkpoint $INIT_CHECKPOINT_GNN \
...
deepspeed llava/train/train_mem.py \
    ...
    --model_name_or_path $MODEL_VERSION \
    --version $PROMPT_VERSION \
    --data_path ./data/data/Molecule-oriented_Instructions/forward_reaction_prediction_train.json \
...
deepspeed llava/train/train_mem.py \
    ...
    --model_name_or_path $MODEL_VERSION \
    --version $PROMPT_VERSION \
    --data_path ./data/data/Molecule-oriented_Instructions/reagent_prediction_train.json \
    --motif_augmented True \
...
deepspeed llava/train/train_mem.py \
    ...
    --model_name_or_path $MODEL_VERSION \
    --version $PROMPT_VERSION \
    --data_path ./data/data/Molecule-oriented_Instructions/retrosynthesis_train.json \
    --motif_augmented True \
...
deepspeed llava/train/train_mem.py \
    ...
    --model_name_or_path $MODEL_VERSION \
    --version $PROMPT_VERSION \
    --data_path ./data/data/ChEBI-20_data/train.txt \
    --graph_tower $GRAPH_TOWER \
    --use_graph_rep False \
    --init_checkpoint $INIT_CHECKPOINT_GNN \
    --pretrain_mm_mlp_adapter $ADAPTER \
