...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path",type=str,default="/apdcephfs_qy3/share_1594716/yandrewchen/InstructMol/checkpoints/Graph-LLaVA-4C-moleculestm-origdata/llava-moleculestm-vicuna-v1-3-7b-pretrain/MoleculeNet-llava-moleculestm-vicuna-v1-3-7b-finetune_lora-full-lr4e-5/")
    parser.add_argument("--dataspace", type=str, default="./data/MoleculeNet_data/")
